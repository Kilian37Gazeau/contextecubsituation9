...
#
#Version 1.0
#Comments: Script qui permet de configurer automatiquement une plage d'adresse, pour le DHCP, avec le nom de domaine et l'adresse IP du serveur de domaine
#
#
#=====================================================#
